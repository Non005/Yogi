...
(function () {
  ...
  // 💡 အခြား JS ဖိုင်များမှ တိုက်ရိုက် ခေါ်သုံးနိုင်အောင် window တွင် ချိတ်ဆက်ပေးထားခြင်း
  window.getApiUrl = getApiUrl;

  window.CONFIG = {
    // 💡 Getter အဖြစ်ပြောင်းထားသဖြင့် localStorage ထဲမှ URL ပြောင်းလျှင် အလိုအလျောက် Update ဖြစ်ပါမည်
    get API_URL() {
      return getApiUrl();
    },
